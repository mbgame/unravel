...
const DECO_BALLS = [
  { color: '#E63946', size: 72,  pos: { top: '5%',    left:   '2%'  }, dur: 4.0, delay: 0.0 },
  { color: '#3A86FF', size: 50,  pos: { top: '10%',   right:  '4%'  }, dur: 3.5, delay: 1.2 },
  { color: '#06D6A0', size: 90,  pos: { bottom: '16%', left:  '-3%' }, dur: 4.8, delay: 0.5 },
  { color: '#8338EC', size: 42,  pos: { top: '44%',   right:  '1%'  }, dur: 3.2, delay: 0.8 },
  { color: '#F4A261', size: 62,  pos: { bottom: '7%', right:  '5%'  }, dur: 5.0, delay: 1.5 },
  { color: '#FFBE0B', size: 28,  pos: { top: '3%',    left:  '47%'  }, dur: 4.2, delay: 0.3 },
] as const;
...
export default function LoginPage() {
  ...
  const { isAuthenticated, loginMutate, isLoggingIn, loginError } = useAuth();
    ...
    >
      ...
      >
        ...
        <form onSubmit={handleSubmit} noValidate>
          ...
          <div style={{ marginBottom: '0.9rem' }}>
            ...
            <input
              ...
              style={{ ...baseInputStyle, opacity: isLoggingIn ? 0.6 : 1 }}
            />
          </div>
        ...
        <button
          ...
          onClick={() => {
            if (typeof window !== 'undefined') window.localStorage.setItem('unravel-guest', 'true');
            router.replace('/');
          }}
